...
//  Output :            It Returns the file description
//  Author :            Sanyam Bhupendrakumar Ravne
//  Date :              16/01/2026
//
//////////////////////////////////////////////////////////////////////////////////////////
                ...
                )
{
    ...
    printf("Numver of bytes that we want to write : %d\n",size);
            ...
            )
{
    ...
    uareaobj.UFDT[fd]->WriteOffset = uareaobj.UFDT[fd]->ReadOffset + size;
    ...
    while(1)
    {
        ...
        else if(iCount == 2)
        {
            ...
            else if(strcmp("write",Command[0]) == 0)
            {
                ...
                if(iRet == ERR_INVALID_PARAMETER)
                {
                    printf("Error : invalid paramete\n");
                }
                else if(iRet == ERR_FILE_NOT_EXIST)
                {
                    printf("Error : There is no such file\n");
                }
                else if(iRet == ERR_PERMITION_DENIED)
                {
                    printf("Error : Unable to write as there is no permiossion\n");
                }
                ...
                {
                    printf("%d bytes gets succedfully written\n",iRet);
                }
            }
            else
            {
        ...
        else if(iCount == 3)
        {
            ...
            {
                iRet = CreateFile(Command[1],atoi(Command[2]));     // atoi is like typecast
                
                if(iRet == ERR_INVALID_PARAMETER)
                {
                    printf("Error : Unable to create the as parameters are invalid\n");
                    printf("Please Refere man page\n");
                }

                if(iRet == ERR_NO_INODES)
                {
                    printf("Error : Unable to create file as there are no inodes\n");
                }
